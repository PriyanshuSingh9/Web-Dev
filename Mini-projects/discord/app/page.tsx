...
export default function Home() {
  return (
    <>
      <main className="flex flex-col lg:flex-row items-center justify-center lg:justify-evenly min-h-[calc(100vh-74px)] p-8 md:p-12 gap-12 lg:gap-8">
        ...
        <div className="w-full max-w-[400px] lg:max-w-[650px] flex justify-center">
          <Image
