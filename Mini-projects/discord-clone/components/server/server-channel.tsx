...
export const ServerChannel = ({
    ...
    return (
        <button
            onClick={onClick}
            className={cn(
                "group px-2 py-1 rounded-md flex items-center gap-x-1.5 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1",
                params?.channelId === channel.id && "bg-zinc-700/20 dark:bg-zinc-700/50"
            )}
        >
            <Icon className="shrink-0 w-4 h-4 text-zinc-500 dark:text-zinc-400" />
            <p className={cn(
