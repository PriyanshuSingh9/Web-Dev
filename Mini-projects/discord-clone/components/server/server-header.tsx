...
import { ChevronDown, UserPlus, Settings, Users, PlusCircle, LogOut, Trash } from "lucide-react";
        ...
        <DropdownMenu>
            <DropdownMenuTrigger
                ...
                <button
                    ...
                    border-b-2 hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transistion">
                    {server?.serverName}
            ...
            <DropdownMenuContent
                ...
                {isModerator && (
                    <DropdownMenuItem className="text-indigo-600 dark:text-indigo-400 px-3 py-2 text-sm cursor-pointer"
                        ...
                        Invite People
                        <UserPlus className="h-4 w-4 ml-auto dark:text-indigo-400 text-indigo-600" />
                    </DropdownMenuItem>
                )}
                {isModerator && (
